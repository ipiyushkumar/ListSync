...
interface Settings {
  apiKeys: { tmdb: string; lastfm: string; anilist: string };
...
export default function SettingsPage() {
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto space-y-6">
      ...
      {/* ────────── 1. API Keys ────────── */}
      <SectionCard icon="🔑" title="API Keys" description="Required keys for media metadata fetching">
        <KeyInput label="TMDB API Key" value={settings.apiKeys.tmdb} placeholder="v3 authenticated key" onChange={(v) => updateApiKey('tmdb', v)} />
        <KeyInput label="Last.fm API Key" value={settings.apiKeys.lastfm} placeholder="Last.fm application key" onChange={(v) => updateApiKey('lastfm', v)} />
        ...
        <div className="bg-gray-800/50 rounded-xl p-4 border border-gray-700/50">
          <p className="text-xs text-gray-500 leading-relaxed">
            API keys are stored locally in <code className="text-purple-400">data/settings.json</code> and never leave your server.
            Get a TMDB key at{' '}
      ...
      {/* ────────── 2. Integrations ────────── */}
      <SectionCard icon="🔗" title="Integrations" description="Connect your favorite platforms to sync watch/listen history">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-0.5">
                    <span className="text-xs text-gray-600 capitalize">{conn.type === 'watch' ? '📺 Watch' : '🎵 Listen'}</span>
      ...
      {/* ────────── 3. AI Configuration ────────── */}
      <SectionCard icon="🤖" title="AI Configuration" description="Use AI for smart recommendations and metadata enrichment">
        <div>
      ...
      {/* ────────── 4. Auto-Detection ────────── */}
      <SectionCard icon="🔍" title="Auto-Detection" description="Automatically detect media from your browser via Chrome extension">
      ...
      {/* ────────── 5. Appearance ────────── */}
      <SectionCard icon="🎨" title="Appearance" description="Customize the look and feel of ListSync">
        <div>
